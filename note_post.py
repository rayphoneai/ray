...
記事は、書き手(商品開発を15年やってきた個人事業主)が自分の実体験 ― AIをこう使った、あるいは こうしくじった ― を約1000字で正直に語る内容です。特定業種(士業など)に限定しないこと。
...
上記タイトルの note 記事の本文を 900〜1200字で書いてください。これは厳守。1200字を超えたら冗長です。情報を盛らず、短く濃く。
...
・字数は900〜1200字を死守する。書き終える前に長すぎないか見直し、冗長な説明は削る
